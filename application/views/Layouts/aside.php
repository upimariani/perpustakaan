<aside class="main-sidebar sidebar-light-primary elevation-4">
	...
	<a href="#" class="brand-link">
		<span class="brand-text font-weight-dark"> Admin Perpustakaan SD</span>
	</a>
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			<div class="image">
				<img src="<?= base_url('asset/sd.jpg') ?>" class="img-circle elevation-2" alt="User Image">
			</div>
			<div class="info">
				<a href="#" class="d-block">SD Negeri 1 Caracas</a>
			</div>
		</div>
